...
<html lang="uk">
    <head>
        <meta charset="UTF-8">
        <title>Результат - Створення сайтів, створення Інтернет магазинів</title>
...
<div class="wrap">
		...
		<div class="mw-800 w100prc mx-auto flex flex-direction-column">
			<div class="h100prc flex align-items-center justify-content-space-between pl-15">
				...
				<div class="menu menuButtons hide-when-burger-btn-true flex">
					<a href="../" title="Створення сайтів, створення Інтернет магазинів">Головна</a>
	...
	<div class="flex flex-grow bg-102" id="app9">
		<div class="mw-800 w100prc mx-auto lh-1-05rem px-15 pt-20 pb-40">
			...
			<h1 class="mb-12">Результат створення сайтів</h1><p>
			Вашій увазі інформація про деякі з виконаних робіт.
			...
			<div class="bt-dashed portfolio-card-bg portfolio-card-mx pb-20">
				...
				<div class="flex gap-10-25 portfolio-wrap">
					...
					<div>
						...
						<a href="https://e-motion.fitness" class="intext" rel="nofollow" title="Сайт-лендінг E-motion Fitness" target="_blank">e-motion.fitness</a>
					</div>
				</div>
			</div>
			<div class="bt-dashed portfolio-card-bg portfolio-card-mx pb-20">
				...
				<div class="flex gap-10-25 portfolio-wrap">
					...
					<div>
						...
						<a href="https://www.marykay.ua" class="intext" rel="nofollow" title="Інтернет магазин косметики Mary Kay" target="_blank">www.marykay.ua</a>
					</div>
				</div>
			</div>
			<div class="bt-dashed portfolio-card-bg portfolio-card-mx pb-20">
				...
				<div class="flex gap-10-25 portfolio-wrap">
					...
					<div>
						...
						<!-- <a href="http://www.best4you.net.ua" class="intext" rel="nofollow" title="Інтернет магазин женской косметики" target="_blank">www.best4you.net.ua</a> -->
					</div>
				</div>
			</div>
			<div class="bt-dashed portfolio-card-bg portfolio-card-mx pb-20">
				...
				<div class="flex gap-10-25 portfolio-wrap">
					...
					<div>
						...
						<!-- <a href="http://www.karkas.net.ua" class="intext" rel="nofollow" title="Сайт компанії Каркас" target="_blank">www.karkas.net.ua</a> -->
					</div>
				</div>
			</div>
			<div class="bt-dashed portfolio-card-bg portfolio-card-mx pb-20">
				...
				<div class="flex gap-10-25 portfolio-wrap">
					...
					<div>
						...
						<!-- <a href="http://www.klimat.in.ua" class="intext" rel="nofollow" title="Інтернет магазин Климат" target="_blank">www.klimat.in.ua</a> -->
					</div>
				</div>
			</div>
			<div class="bt-dashed portfolio-card-bg portfolio-card-mx pb-20">
			...
			<div class="bt-dashed portfolio-card-bg portfolio-card-mx pb-20">
				...
				<div class="flex gap-10-25 portfolio-wrap">
					...
					<div>
						...
						<!-- <a href="http://www.klimatshop.com.ua" class="intext" rel="nofollow" title="Інтернет магазин Климатшоп" target="_blank">www.klimatshop.com.ua</a> -->
					</div>
				</div>
			</div>
			<div class="bt-dashed portfolio-card-bg portfolio-card-mx pb-20">
				...
				<div class="flex gap-10-25 portfolio-wrap">
					...
					<div>
						...
						<!-- <a href="http://www.avtoshina.net" class="intext" rel="nofollow" title="Інтернет магазин Автошина" target="_blank">www.avtoshina.net</a> -->
					</div>
				</div>
			</div>
			<div class="bt-dashed portfolio-card-bg portfolio-card-mx pb-20">
				...
				<div class="flex gap-10-25 portfolio-wrap">
					...
					<div>
						...
						<a href="https://www.cheil.com/ua" class="intext" rel="nofollow" title="Адаптивна верстка сайту-лендінгу для Cheil Ukraine (Samsung)" target="_blank">www.cheil.com/ua</a>
					</div>
				</div>
			</div>
			<div class="bt-dashed portfolio-card-mx">
				...
				<div class="flex gap-10-25 portfolio-wrap mb-20">
					...
					<div>
						...
						<!-- <a href="http://www.vsetut.biz" class="intext" rel="nofollow" title="Інтернет магазин компанії Синко" target="_blank">www.vsetut.biz</a> -->
					</div>
				</div>
			</div>
                    ...
                    <div @click.stop class="dialog__content3 bg-black w100prc h100prc flex flex-direction-column justify-content-space-between user-select-none" v-if="modal1Visible" v-cloak>
                        ...
                        <div class="flex justify-content-center align-items-center h-60">
                            <div class="flex-grow mr-20">
                                <buttom class="nav-link-2 flex align-items-center br-10" @click="previousImage()"><div class="nav-btn flex justify-content-center align-items-center ml-auto">
								<img src="../src/img/previous.png" class="" alt="Предыдущее фото"/></div></buttom>
                            </div>
                            <div class="bg-gray-2 font-roboto fs-1-1rem color-1 br-10 px-12 py-12">
								...
								<!-- [ nextId: {{ nextId }} ] <br>
								[ prevImg: {{ prevImg.src }} ]
                                [ nextImg: {{ nextImg.src }} ] <br> -->
                            </div>
                            <div class="flex-grow ml-20">
                                <buttom class="nav-link-2 flex align-items-center br-10" @click="nextImage()"><div class="nav-btn flex justify-content-center align-items-center">
									<img src="../src/img/next.png" class="" alt="Следующее фото"></div></buttom>
                            </div>
                        </div>
                    </div>
                </div>
